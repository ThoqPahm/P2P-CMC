...
<head>
    ...
    <?php if (($page ?? '') === 'admin-moderation'): ?><link href="assets/css/moderation.css?v=3" rel="stylesheet"><?php endif; ?>
    ...
    <?php if ($isStudentWorkspace): ?><link href="assets/css/student-layout.css?v=7" rel="stylesheet"><?php endif; ?>
</head>
