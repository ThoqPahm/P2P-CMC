...
require_once __DIR__ . '/ChatPrivacy.php';
...
// Public demo fixtures travel with Git; private SQLite data never does.
if (!defined('AMBASSADOR_FIXTURE_MANUAL_INSTALL')) AmbassadorProfiles::installBundledProfiles($db);
