...
function ui_setting_defaults(): array
{
    return [
        ...
        'widget_ai_name' => 'CMCU AI',
        'widget_ai_welcome' => 'Chào bạn, mình là CMCU AI. Bạn đang quan tâm điều gì ở CMCU? Cứ nói tự nhiên nhé, chưa biết bắt đầu từ đâu cũng không sao.',
