    ...
    <div class="row g-4">
        <?php foreach ($ambassadors as $index => $ambassador): ?>
            <div class="col-md-6 col-lg-4"><article class="ambassador-card h-100">
                <div class="ambassador-cover cover-<?= ($index % 3) + 1 ?>"><span class="profile-monogram"><?= AmbassadorProfiles::avatarHtml($ambassador) ?></span><?php if ($ambassador['is_online']): ?><span class="online-badge"><i></i> Đang online</span><?php else: ?><span class="offline-badge">Phản hồi trong ngày</span><?php endif; ?></div>
