...
<details class="panel-card inbox-policy mb-3">
    ...
    <p>Tin nhắn được kiểm tra tự động. Người phụ trách chỉ xem nội dung bị đánh dấu và phần hội thoại cần thiết để xử lý. Câu hỏi chuyển đến Ban Tuyển sinh được gửi riêng, không kèm toàn bộ lịch sử.</p>
</details>
