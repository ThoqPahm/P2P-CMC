...
?>
<p class="helper-note">Tin nhắn được kiểm tra tự động. Người phụ trách chỉ xem tin bị đánh dấu và ngữ cảnh gần đó; câu hỏi bạn chuyển tiếp được gửi riêng, không kèm toàn bộ lịch sử.</p>
...
<details class="panel-card p-3 mb-3" data-ai-assist="conversation_ai_assist" data-conversation-id="<?= $selected ?>">
    ...
    <p class="helper-note mt-3">Khi bạn bấm tạo gợi ý, tối đa 20 tin gần nhất được gửi đến mô hình AI đang cấu hình. Email, số liên hệ và mã số dài được lọc tự động, nhưng bộ lọc không bảo đảm ẩn mọi dữ liệu cá nhân. Không dùng cho trao đổi chứa thông tin nhạy cảm. AI chỉ soạn nháp; bạn xem lại trước khi gửi hoặc chuyển cán bộ.</p>
    <button class="btn btn-sm btn-outline-brand" type="button" data-ai-run>Tóm tắt & gợi ý trả lời</button>
